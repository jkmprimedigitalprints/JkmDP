...
export const LoginPage: React.FC<LoginPageProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const savedPasswords = savedPasswordsRaw
      ? JSON.parse(savedPasswordsRaw)
      : {};

    const savedAdminPassword =
      savedPasswords[cleanUserLower] ||
      savedPasswords['admin'] ||
      localStorage.getItem('jkm_admin_custom_password') ||
      'Jkmprime@2027';
    ...
    if (isDefaultAdmin && isValidAdminPassword) {
      ...
      try {
        ...
        if (
          ...
          try {
            ...
            console.warn(
              'Background auto-provisioning of default credentials failed:',
              createErr
            );
          }
        }
      ...
      toast.success(
        'Admin verified! Redirecting to Workspace...'
      );
    ...
    try {
      ...
      console.warn(
        'Firebase authentication failed for admin user:',
        err.code
      );
      ...
      let errorMsg =
        'Invalid admin username or password. Please verify and retry.';
      ...
      if (
        ...
        errorMsg =
          'Incorrect password. Please verify and retry.';
      } else if (err.code === 'auth/invalid-email') {
        errorMsg =
          'Invalid username or email format.';
      } else if (err.code === 'auth/user-not-found') {
        errorMsg =
          'Admin account not found. Please verify your credentials.';
      }
  ...
  const handleForgotPassword = () => {
    toast.info(
      'To reset master credentials, contact the system administrator or consult offline terminal docs.'
    );
  };
            ...
            <div className="space-y-4 my-8">
              ...
              <div className="p-3.5 rounded-2xl bg-slate-800/60 border border-slate-700/60 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400 leading-relaxed mt-0.5">
                    Live queues for DTF printing, mug sublimation,
                    rush photos, and materials inventory.
                  </p>
                </div>
              ...
              <div className="p-3.5 rounded-2xl bg-slate-800/60 border border-slate-700/60 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400 leading-relaxed mt-0.5">
                    Exclusive master access for sales analytics,
                    order management, material audits, and print queues.
                  </p>
                </div>
